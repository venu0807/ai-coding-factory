  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50">
      <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-sm border w-full max-w-sm">
        ...
        <button className="w-full bg-green-600 text-white rounded-lg py-2 font-medium">Sign In</button>
        <p className="text-sm text-gray-500 mt-4 text-center">
          No account? <Link to="/signup" className="text-green-600">Sign up</Link>
        </p>
      </form>
    </div>
  );
